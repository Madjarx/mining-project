...
module.exports = {
  ...
  //region networks: { ...  hardhat: { ... }, localhost: { ... }, ...
  networks: {
    hardhat: {
      baseFeePerGas: 1,
...
//region task: mineContractAddress
task(
  "mineContractAddress",
...
//region function addr(ethers, addr)
...
//region function send(signer, txparams)
...
//region task: send --from --to --amount --data --gasPrice --gasLimit
task("send", "Send ETH")
